...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{images/overviewSpectra.pdf}
...
A typical AE monitoring system  takes its input from an AE sensor that converts dynamic surface motion into electric signals . 
