...
Frequency ranges from \SIrange{50}{2500}{\hertz} \cite{andres_respiratory_2018}, with the majority of energy in the range of \SIrange{50}{500}{\hertz}\cite{pasterkamp_respiratory_1997}.
...
As Emissions are generated by the movement of the joint surfaces, this dynamic approach is the main advantage over static mode examinations such as MRI or Ultrasound andthus can be correlated to joint angle and load.
...
Adjusting the thickness, shape or size allows for strucutral reconfiguration and a highly adjustable device that can be tailored to application speficic requirements. 
 Thus PE sensors can be designed to detect frequencies from  \SI{20}{k\hertz} up to several M\SI{}{\hertz} \cite{ali_piezoelectric_2020}
...
\subsection{Triboelectric Sensors}
...
\section{Air Borne Microphone Sounds}
\begin{figure}
\centering
...
Unlike traditional piezoelectric materials with contain intrinsic dipolar units, electrets by definition are dielectric materials which can store electrical charge / polarization quasipermanently \cite{sessler_physical_1987}.
...
\chapter{New Measurement Approaches}
